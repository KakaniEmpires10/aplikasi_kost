...
import { propsDialogDelete } from "../rent.constant"
import { deleteRent } from "@/action/rent-action"
...
const ModalDelete = ({ id, open, onOpenChange }: propsDialogDelete) => {
    ...
    const handleDelete = async () => {
        toast.promise(
            ...
            {
                loading: 'Menghapus...',
                success: (success) => success?.message || "Rumah Berhasil Dihapus",
                error: (err) => err.message || "Rumah Gagal Dihapus",
            }
        )
    }
        ...
        <AlertDialog open={open} onOpenChange={onOpenChange}>
            <AlertDialogContent>
                <AlertDialogHeader className="items-center">
                    ...
                    <AlertDialogTitle>Yakin Mau Menghapus Rumah Sewa Ini?</AlertDialogTitle>
