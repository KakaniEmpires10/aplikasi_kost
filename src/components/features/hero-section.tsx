...
import { ArrowRight, HouseIcon, SendHorizonal } from 'lucide-react'
                    ...
                    <div className="relative mx-auto max-w-5xl px-6 py-28 lg:py-20">
                        ...
                        <div className="absolute inset-0 -mx-4 rounded-3xl p-3 lg:col-span-3">
                            <div className="relative">
                                ...
                                <Image className="hidden dark:block" src="/image/placeholder/bg-dark.png" alt="app illustration" width={2796} height={2008} />
                                <Image className="dark:hidden" src="/image/placeholder/bg-light.png" alt="app illustration" width={2796} height={2008} />
                            </div>
                        </div>
                    </div>
                </section>
