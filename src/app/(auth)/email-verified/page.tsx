...
const EmailVerifiedpage = () => {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen p-5 bg-background min-w-screen">
            <div className="max-w-xl p-8 text-center text-card-foreground bg-card shadow-xl lg:max-w-3xl rounded-3xl lg:p-12">
                <h3 className="text-2xl font-bold">Email anda berhasil diverifikasi 😁</h3>
                ...
                <p>Klik pada tombol dibawah untuk lanjut ke halaman dashboard</p>
                <div className="mt-4">
                    <Button asChild>
                        <Link href="/dashboard">
                    ...
                    <p className="mt-4 text-xs italic text-accent-foreground">
                        Note: halaman ini akan otomatis redirect dalam 2 detik
                    </p>
                </div>
            </div>
        </div>
